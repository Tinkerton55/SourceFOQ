...
void C_BaseAnimating::ProcessMuzzleFlashEvent()
{
	...
	if ( muzzleflash_light.GetBool() )
	{
		...
		{
			//Tinkerton: Old muzzle flash code
			...
			//Tinkerton: New muzzle flash code - stolen from SDK wiki

			Vector vAttachment, vAng;
			QAngle angles;

			GetAttachment(0, vAttachment, angles); // set 1 instead "attachment"
			...
			dl->color.g = 170;
			dl->color.b = 75;
			dl->die = gpGlobals->curtime + 0.06f;
			dl->radius = 384.0f;
			dl->decay = 768.0f;
		}
	}
