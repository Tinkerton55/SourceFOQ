...
#else
ConVar	sv_stopspeed("sv_stopspeed", "100", FCVAR_CHEAT | FCVAR_NOTIFY | FCVAR_REPLICATED, "Minimum stopping speed when on ground."); //FCVAR_DEVELOPMENTONLY
...
#else
	ConVar	sv_accelerate	( "sv_accelerate", "10.0", FCVAR_NOTIFY | FCVAR_REPLICATED); //FCVAR_DEVELOPMENTONLY
#endif // CSTRIKE_DLL
...
ConVar	sv_rollspeed	( "sv_rollspeed", "300", FCVAR_NOTIFY | FCVAR_REPLICATED);
...
#else
ConVar	sv_friction("sv_friction", "4", FCVAR_CHEAT | FCVAR_NOTIFY | FCVAR_REPLICATED, "World friction."); //FCVAR_DEVELOPMENTONLY
#endif // DOD_DLL || CSTRIKE_DLL
...
ConVar	sv_backspeed	( "sv_backspeed", "1.0", FCVAR_ARCHIVE | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "How much to slow down backwards motion" );
