...
ConVar sk_hunter_flechette_explode_dmg( "sk_hunter_flechette_explode_dmg", "0.0" );
ConVar sk_hunter_flechette_explode_radius( "sk_hunter_flechette_explode_radius", "0.0" );
ConVar hunter_flechette_explode_delay( "hunter_flechette_explode_delay", "0.5" );
